...
Router.map(function() {
 	this.route('mainPage', {
 		path: '/',
 		action: function() {
 			this.render('mainPageHeader', {to: 'headerContent'});
 			this.render('mainPage');
 		}
 	});

 	this.route('newRidePage', {
 		path: '/newride',
 		action: function() {
 			this.render('newRidePageHeader', {to: 'headerContent'});
 			this.render('newRidePage');
 		}
 	});

 	this.route('userProfilePage', {
 		path: '/profile',
 		data: function() {
 			return Meteor.user();
 		}
